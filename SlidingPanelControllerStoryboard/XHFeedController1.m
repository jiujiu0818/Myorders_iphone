...
- (void)viewDidLoad
{
    ...
    self.likeAlbum = [album findAll];
    ODRefreshControl *refreshControl = [[ODRefreshControl alloc] initInScrollView:self.feedTableView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.nameLabel.text = [self.likeAlbum[indexPath.row] user];
    cell.updateLabel.text = [self.likeAlbum[indexPath.row] name];
    
    cell.dateLabel.text = @"1 hr ago";
    cell.likeCountLabel.text = @"293likes";
    //      cell.commentCountLabel.text = @"55";
    cell.picImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@",[self.likeAlbum[indexPath.row] pic]]];
  ...
  //      cell.commentCountLabel.text = @"55";
        ...
        cell.dateLabel.text = @"1 hr ago";
        cell.likeCountLabel.text = @"134likes";
